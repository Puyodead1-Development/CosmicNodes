...
public enum UMaterial {
	/*
	 * <item>(1.8.9, 1.9.4, 1.10.2, 1.11.2, 1.12.2, 1.13.2, 1.14.2) 1.8.9 =
	 * http://docs.codelanx.com/Bukkit/1.8/org/bukkit/Material.html 1.13.2 = ?
	 * 1.14.2 = https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/Material.html
	 * visual = https://www.digminecraft.com/lists/item_id_list_pc.php Special
	 * blocks = https://www.planetminecraft.com/blog/secret-blocks-vanilla/
	 */
	ACACIA_BOAT("BOAT", null, null, null, "BOAT_ACACIA", "ACACIA_BOAT"),
	ACACIA_BUTTON("WOOD_BUTTON", null, null, null, null, "ACACIA_BUTTON"),
	ACACIA_DOOR("ACACIA_DOOR_ITEM", null, null, null, null, "ACACIA_DOOR"), ACACIA_FENCE("ACACIA_FENCE", 0),
	ACACIA_FENCE_GATE("ACACIA_FENCE_GATE", 0), ACACIA_LEAVES("LEAVES_2", null, null, null, null, "ACACIA_LEAVES"),
	...
	ACACIA_SLAB(4, "WOOD_STEP", null, null, null, null, "ACACIA_SLAB"), ACACIA_STAIRS("ACACIA_STAIRS"),
	...
	ACACIA_WOOD(12, "LOG_2", null, null, null, null, "ACACIA_WOOD"), ACTIVATOR_RAIL("ACTIVATOR_RAIL"), AIR("AIR"),
	ALLIUM(2, "RED_ROSE", null, null, null, null, "ALLIUM"), ANDESITE(5, "STONE", null, null, null, null, "ANDESITE"),
	ANVIL("ANVIL"), APPLE("APPLE"), ARMOR_STAND("ARMOR_STAND"), ARROW("ARROW"),
	...
	AZURE_BLUET(3, "RED_ROSE", null, null, null, null, "AZURE_BLUET"), BAKED_POTATO("BAKED_POTATO"),
	BAMBOO(null, null, null, null, null, null, "BAMBOO"),
	BAMBOO_SAPLING(null, null, null, null, null, null, "BAMBOO_SAPLING"),
	BARREL(null, null, null, null, null, null, "BARREL"), BARRIER("BARRIER"),
	BAT_SPAWN_EGG(65, "MONSTER_EGG", null, null, null, null, "BAT_SPAWN_EGG"), BEACON("BEACON"), BEDROCK("BEDROCK"),
	BEEF("RAW_BEEF", null, null, null, null, "BEEF"), BEETROOT(null, null, null, null, "BEETROOT"),
	BEETROOT_SEEDS(null, null, null, null, "BEETROOT_SEEDS"), BEETROOT_SOUP(null, null, null, null, "BEETROOT_SOUP"),
	...
	BIRCH_DOOR("BIRCH_DOOR_ITEM", null, null, null, null, "BIRCH_DOOR"), BIRCH_FENCE("BIRCH_FENCE"),
	BIRCH_FENCE_GATE("BIRCH_FENCE_GATE"), BIRCH_LEAVES(2, "LEAVES", null, null, null, null, "BIRCH_LEAVES"),
	...
	BLAST_FURNACE(null, null, null, null, null, null, "BLAST_FURNACE"), BLAZE_POWDER("BLAZE_POWDER"),
	BLAZE_ROD("BLAZE_ROD"), BLAZE_SPAWN_EGG(61, "MONSTER_EGG", null, null, null, null, "BLAZE_SPAWN_EGG"),
	...
	BLUE_WOOL(11, "WOOL", null, null, null, null, "BLUE_WOOL"), BONE("BONE"), BONE_BLOCK(null, null, "BONE_BLOCK"),
	BONE_MEAL(15, "INK_SACK", null, null, null, null, "BONE_MEAL"), BOOK("BOOK"), BOOKSHELF("BOOKSHELF"), BOW("BOW"),
	BOWL("BOWL"), BRAIN_CORAL(null, null, null, null, null, "BRAIN_CORAL"),
	BRAIN_CORAL_BLOCK(null, null, null, null, null, "BRAIN_CORAL_BLOCK"),
	BRAIN_CORAL_FAN(null, null, null, null, null, "BRAIN_CORAL_FAN"),
	BRAIN_CORAL_WALL_FAN(null, null, null, null, null, "BRAIN_CORAL_WALL_FAN"), BREAD("BREAD"),
	BREWING_STAND("BREWING_STAND"), BREWING_STAND_ITEM("BREWING_STAND_ITEM", null, null, null, null, "BREWING_STAND"),
	BRICK("BRICK", null, null, null, "CLAY_BRICK", "BRICK"),
	BRICK_SLAB(4, "STEP", null, null, null, null, "BRICK_SLAB"), BRICK_STAIRS("BRICK_STAIRS"),
	...
	BROWN_LEATHER_LEGGINGS("LEATHER_LEGGINGS", 12, Color.fromRGB(102, 76, 51)), BROWN_MUSHROOM("BROWN_MUSHROOM"),
	...
	BUBBLE_CORAL_WALL_FAN(null, null, null, null, null, "BUBBLE_CORAL_WALL_FAN"), BUCKET("BUCKET"),
	BURNING_FURNACE("BURNING_FURNACE", null, null, null, null, "LEGACY_BURNING_FURNACE"), CACTUS("CACTUS"),
	CAKE("CAKE"), CAKE_BLOCK("CAKE_BLOCK", null, null, null, null, "CAKE"),
	CAMPFIRE(null, null, null, null, null, null, "CAMPFIRE"), CARROT("CARROT"),
	...
	CARVED_PUMPKIN("PUMPKIN", null, null, null, null, "CARVED_PUMPKIN"), CAULDRON("CAULDRON"),
	...
	CHAINMAIL_BOOTS("CHAINMAIL_BOOTS"), CHAINMAIL_CHESTPLATE("CHAINMAIL_CHESTPLATE"),
	CHAINMAIL_HELMET("CHAINMAIL_HELMET"), CHAINMAIL_LEGGINGS("CHAINMAIL_LEGGINGS"),
	CHARCOAL(1, "COAL", null, null, null, null, "CHARCOAL"), CHEST("CHEST"),
	...
	CHORUS_FLOWER(null, "CHORUS_FLOWER"), CHORUS_FRUIT(null, "CHORUS_FRUIT"), CHORUS_PLANT(null, "CHORUS_PLANT"),
	CLAY("CLAY"), CLAY_BALL("CLAY_BALL"), CLOCK("WATCH", null, null, null, null, "CLOCK"), COAL("COAL"),
	COAL_BLOCK("COAL_BLOCK"), COAL_ORE("COAL_ORE"), COARSE_DIRT(1, "DIRT", null, null, null, null, "COARSE_DIRT"),
	COBBLESTONE("COBBLESTONE"), COBBLESTONE_SLAB(3, "STEP", null, null, null, null, "COBBLESTONE_SLAB"),
	COBBLESTONE_STAIRS("COBBLESTONE_STAIRS"),
	COBBLESTONE_WALL("COBBLE_WALL", null, null, null, null, "COBBLESTONE_WALL"),
	COBWEB("WEB", null, null, null, null, "COBWEB"), COCOA("COCOA"),
	COCOA_BEANS(3, "INK_SACK", null, null, null, null, "COCOA_BEANS"),
	COD(2, "RAW_FISH", null, null, null, null, "COD"), COD_BUCKET(null, null, null, null, null, null, "COD_BUCKET"),
	...
	COMPARATOR("REDSTONE_COMPARATOR", null, null, null, null, "COMPARATOR"), COMPASS("COMPASS"),
	COMPOSTER(null, null, null, null, null, null, "COMPOSTER"), CONDUIT(null, null, null, null, null, "CONDUIT"),
	COOKED_BEEF("COOKED_BEEF"), COOKED_CHICKEN("COOKED_CHICKEN"),
	COOKED_COD("COOKED_FISH", null, null, null, null, "COOKED_COD"), COOKED_MUTTON("COOKED_MUTTON"),
	COOKED_PORKCHOP("GRILLED_PORK", null, null, null, null, "COOKED_PORKCHOP"), COOKED_RABBIT("COOKED_RABBIT"),
	COOKED_SALMON(1, "COOKED_FISH", null, null, null, null, "COOKED_SALMON"), COOKIE("COOKIE"),
	...
	DARK_OAK_DOOR_ITEM("DARK_OAK_DOOR_ITEM", null, null, null, null, "DARK_OAK_DOOR"), DARK_OAK_FENCE("DARK_OAK_FENCE"),
	...
	DARK_OAK_SLAB(5, "WOOD_STEP", null, null, null, null, "DARK_OAK_SLAB"), DARK_OAK_STAIRS("DARK_OAK_STAIRS"),
	...
	DAYLIGHT_DETECTOR("DAYLIGHT_DETECTOR"), DEAD_BRAIN_CORAL(null, null, null, null, null, "DEAD_BRAIN_CORAL"),
	...
	DEBUG_STICK(null, null, null, null, null, "DEBUG_STICK"), DETECTOR_RAIL("DETECTOR_RAIL"), DIAMOND("DIAMOND"),
	DIAMOND_AXE("DIAMOND_AXE"), DIAMOND_BLOCK("DIAMOND_BLOCK"), DIAMOND_BOOTS("DIAMOND_BOOTS"),
	DIAMOND_CHESTPLATE("DIAMOND_CHESTPLATE"), DIAMOND_HELMET("DIAMOND_HELMET"), DIAMOND_HOE("DIAMOND_HOE"),
	DIAMOND_HORSE_ARMOR("DIAMOND_BARDING", null, null, null, null, "DIAMOND_HORSE_ARMOR"),
	DIAMOND_LEGGINGS("DIAMOND_LEGGINGS"), DIAMOND_ORE("DIAMOND_ORE"), DIAMOND_PICKAXE("DIAMOND_PICKAXE"),
	DIAMOND_SHOVEL("DIAMOND_SPADE", null, null, null, null, "DIAMOND_SHOVEL"), DIAMOND_SWORD("DIAMOND_SWORD"),
	...
	DIORITE_WALL(null, null, null, null, null, null, "DIORITE_WALL"), DIRT("DIRT"), DISPENSER("DISPENSER"),
	...
	DRAGON_BREATH(null, "DRAGONS_BREATH", null, null, null, "DRAGON_BREATH"), DRAGON_EGG("DRAGON_EGG"),
	...
	DRIED_KELP_BLOCK(null, null, null, null, null, "DRIED_KELP_BLOCK"), DROPPER("DROPPER"),
	DROWNED_SPAWN_EGG(null, null, null, null, null, "DROWNED_SPAWN_EGG"), EGG("EGG"),
	ELDER_GUARDIAN_SPAWN_EGG(null, null, null, null, null, "ELDER_GUARDIAN_SPAWN_EGG"), ELYTRA(null, "ELYTRA"),
	EMERALD("EMERALD"), EMERALD_BLOCK("EMERALD_BLOCK"), EMERALD_ORE("EMERALD_ORE"), ENCHANTED_BOOK("ENCHANTED_BOOK"),
	...
	ENCHANTED_BOOK_CHANNELING("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("CHANNELING") != null ? "CHANNELING" : "PROTECTION_EXPLOSIONS"),
			1),
	ENCHANTED_BOOK_CURSE_OF_BINDING("ENCHANTED_BOOK",
			Enchantment.getByName(
					Enchantment.getByName("BINDING_CURSE") != null ? "BINDING_CURSE" : "PROTECTION_EXPLOSIONS"),
			1),
	ENCHANTED_BOOK_CURSE_OF_VANISHING("ENCHANTED_BOOK",
			Enchantment.getByName(
					Enchantment.getByName("VANISHING_CURSE") != null ? "VANISHING_CURSE" : "PROTECTION_EXPLOSIONS"),
			1),
	...
	ENCHANTED_BOOK_FROST_WALKER_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("FROST_WALKER") != null ? "FROST_WALKER" : "LOOT_BONUS_BLOCKS"),
			1),
	ENCHANTED_BOOK_FROST_WALKER_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("FROST_WALKER") != null ? "FROST_WALKER" : "LOOT_BONUS_BLOCKS"),
			2),
	ENCHANTED_BOOK_IMPALING_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 1),
	ENCHANTED_BOOK_IMPALING_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 2),
	ENCHANTED_BOOK_IMPALING_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 3),
	ENCHANTED_BOOK_IMPALING_4("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 4),
	ENCHANTED_BOOK_IMPALING_5("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("IMPALING") != null ? "IMPALING" : "LOOT_BONUS_BLOCKS"), 5),
	...
	ENCHANTED_BOOK_LOYALTY_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 1),
	ENCHANTED_BOOK_LOYALTY_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 2),
	ENCHANTED_BOOK_LOYALTY_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("LOYALTY") != null ? "LOYALTY" : "LOOT_BONUS_MOBS"), 3),
	...
	ENCHANTED_BOOK_MENDING("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("MENDING") != null ? "MENDING" : "LURE"), 1),
	ENCHANTED_BOOK_MULTI_SHOT("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("MULTI_SHOT") != null ? "MULTI_SHOT" : "LURE"), 1),
	ENCHANTED_BOOK_PIERCING_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("PIERCING") != null ? "PIERCING" : "LURE"), 1),
	ENCHANTED_BOOK_PIERCING_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("PIERCING") != null ? "PIERCING" : "LURE"), 2),
	ENCHANTED_BOOK_PIERCING_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("PIERCING") != null ? "PIERCING" : "LURE"), 3),
	ENCHANTED_BOOK_PIERCING_4("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("PIERCING") != null ? "PIERCING" : "LURE"), 4),
	...
	ENCHANTED_BOOK_QUICK_CHARGE_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"),
			1),
	ENCHANTED_BOOK_QUICK_CHARGE_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"),
			2),
	ENCHANTED_BOOK_QUICK_CHARGE_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("QUICK_CHARGE") != null ? "QUICK_CHARGE" : "ARROW_KNOCKBACK"),
			3),
	...
	ENCHANTED_BOOK_RIPTIDE_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("RIPTIDE") != null ? "RIPTIDE" : "OXYGEN"), 1),
	ENCHANTED_BOOK_RIPTIDE_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("RIPTIDE") != null ? "RIPTIDE" : "OXYGEN"), 2),
	ENCHANTED_BOOK_RIPTIDE_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("RIPTIDE") != null ? "RIPTIDE" : "OXYGEN"), 3),
	...
	ENCHANTED_BOOK_SWEEPING_EDGE_1("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"),
			1),
	ENCHANTED_BOOK_SWEEPING_EDGE_2("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"),
			2),
	ENCHANTED_BOOK_SWEEPING_EDGE_3("ENCHANTED_BOOK",
			Enchantment.getByName(Enchantment.getByName("SWEEPING_EDGE") != null ? "SWEEPING_EDGE" : "DAMAGE_UNDEAD"),
			3),
	...
	END_CRYSTAL(null, null, null, "END_CRYSTAL"), END_GATEWAY(null, "END_GATEWAY"),
	END_PORTAL(null, null, null, null, null, "END_PORTAL"),
	END_PORTAL_FRAME("ENDER_PORTAL_FRAME", null, null, null, null, "END_PORTAL_FRAME"), END_ROD(null, "END_ROD"),
	...
	END_STONE_BRICKS(null, "END_BRICKS", null, null, null, "END_STONE_BRICKS"), ENDER_CHEST("ENDER_CHEST"),
	ENDER_EYE("EYE_OF_ENDER", null, null, null, null, "ENDER_EYE"), ENDER_PEARL("ENDER_PEARL"),
	...
	FARMLAND("SOIL", null, null, null, null, "FARMLAND"), FEATHER("FEATHER"),
	FERMENTED_SPIDER_EYE("FERMENTED_SPIDER_EYE"), FERN(2, "LONG_GRASS", null, null, null, null, "FERN"),
	FILLED_MAP("MAP", null, null, null, null, "FILLED_MAP"), FIRE("FIRE"),
	...
	FIREWORK_STAR("FIREWORK_CHARGE", null, null, null, null, "FIREWORK_STAR"), FISHING_ROD("FISHING_ROD"),
	FLETCHING_TABLE(null, null, null, null, null, null, "FLETCHING_TABLE"), FLINT("FLINT"),
	FLINT_AND_STEEL("FLINT_AND_STEEL"),
	FLOWER_BANNER_PATTERN(null, null, null, null, null, null, "FLOWER_BANNER_PATTERN"), FLOWER_POT("FLOWER_POT"),
	FLOWER_POT_ITEM("FLOWER_POT_ITEM", null, null, null, null, "FLOWER_POT"),
	FOX_SPAWN_EGG(null, null, null, null, null, null, "FOX_SPAWN_EGG"), FROSTED_ICE(null, "FROSTED_ICE"),
	FURNACE("FURNACE"), FURNACE_MINECART("POWERED_MINECART", null, null, null, null, "FURNACE_MINECART"),
	GHAST_SPAWN_EGG(56, "MONSTER_EGG", null, null, null, null, "GHAST_SPAWN_EGG"), GHAST_TEAR("GHAST_TEAR"),
	GLASS("GLASS"), GLASS_BOTTLE("GLASS_BOTTLE"), GLASS_PANE("THIN_GLASS", null, null, null, null, "GLASS_PANE"),
	...
	GLOWSTONE("GLOWSTONE"), GLOWSTONE_DUST("GLOWSTONE_DUST"), GOLD_BLOCK("GOLD_BLOCK"), GOLD_INGOT("GOLD_INGOT"),
	GOLD_NUGGET("GOLD_NUGGET"), GOLD_ORE("GOLD_ORE"), GOLDEN_APPLE("GOLDEN_APPLE"),
	GOLDEN_AXE("GOLD_AXE", null, null, null, null, "GOLDEN_AXE"),
	GOLDEN_BOOTS("GOLD_BOOTS", null, null, null, null, "GOLDEN_BOOTS"), GOLDEN_CARROT("GOLDEN_CARROT"),
	...
	GRANITE_WALL(null, null, null, null, null, null, "GRANITE_WALL"), GRASS("GRASS"),
	GRASS_BLOCK("GRASS", null, null, null, null, "GRASS_BLOCK"), GRASS_PATH(null, "GRASS_PATH"), GRAVEL("GRAVEL"),
	...
	GUNPOWDER("SULPHUR", null, null, null, null, "GUNPOWDER"), HAY_BLOCK("HAY_BLOCK"),
	...
	HOPPER("HOPPER"), HOPPER_MINECART("HOPPER_MINECART"), HORN_CORAL(null, null, null, null, null, "HORN_CORAL"),
	...
	HUSK_SPAWN_EGG(23, null, null, null, "MONSTER_EGG", null, "HUSK_SPAWN_EGG"), ICE("ICE"),
	...
	INK_SAC("INK_SACK", null, null, null, null, "INK_SAC"), IRON_AXE("IRON_AXE"),
	IRON_BARS("IRON_FENCE", null, null, null, null, "IRON_BARS"), IRON_BLOCK("IRON_BLOCK"), IRON_BOOTS("IRON_BOOTS"),
	IRON_CHESTPLATE("IRON_CHESTPLATE"), IRON_DOOR("IRON_DOOR_BLOCK", null, null, null, null, "IRON_DOOR"),
	IRON_DOOR_ITEM("IRON_DOOR"), IRON_HELMET("IRON_HELMET"), IRON_HOE("IRON_HOE"),
	IRON_HORSE_ARMOR("IRON_BARDING", null, null, null, null, "IRON_HORSE_ARMOR"), IRON_INGOT("IRON_INGOT"),
	IRON_LEGGINGS("IRON_LEGGINGS"), IRON_NUGGET(null, null, null, "IRON_NUGGET"), IRON_ORE("IRON_ORE"),
	IRON_PICKAXE("IRON_PICKAXE"), IRON_SHOVEL("IRON_SPADE", null, null, null, null, "IRON_SHOVEL"),
	IRON_SWORD("IRON_SWORD"), IRON_TRAPDOOR("IRON_TRAPDOOR"), ITEM_FRAME("ITEM_FRAME"),
	JACK_O_LANTERN("JACK_O_LANTERN"), JIGSAW(null, null, null, null, null, null, "JIGSAW"), JUKEBOX("JUKEBOX"),
	JUNGLE_BOAT("BOAT", null, null, null, "BOAT_JUNGLE", "JUNGLE_BOAT"),
	JUNGLE_BUTTON("WOOD_BUTTON", null, null, null, null, "JUNGLE_BUTTON"), JUNGLE_DOOR("JUNGLE_DOOR"),
	JUNGLE_DOOR_ITEM("JUNGLE_DOOR_ITEM", null, null, null, null, "JUNGLE_DOOR"), JUNGLE_FENCE("JUNGLE_FENCE"),
	JUNGLE_FENCE_GATE("JUNGLE_FENCE_GATE"), JUNGLE_LEAVES(3, "LEAVES", null, null, null, null, "JUNGLE_LEAVES"),
	...
	JUNGLE_WOOD(15, "LOG", null, null, null, null, "JUNGLE_WOOD"), KELP(null, null, null, null, null, "KELP"),
	KELP_PLANT(null, null, null, null, null, "KELP_PLANT"), KNOWLEDGE_BOOK("BOOK", null, null, null, "KNOWLEDGE_BOOK"),
	LADDER("LADDER"), LANTERN(null, null, null, null, null, null, "LANTERN"), LAPIS_BLOCK("LAPIS_BLOCK"),
	LAPIS_LAZULI(4, "INK_SACK", null, null, null, null, "LAPIS_LAZULI"), LAPIS_ORE("LAPIS_ORE"),
	LARGE_FERN(3, "DOUBLE_PLANT", null, null, null, null, "LARGE_FERN"), LAVA("LAVA"), LAVA_BUCKET("LAVA_BUCKET"),
	LEAD("LEASH", null, null, null, null, "LEAD"), LEATHER("LEATHER"), LEATHER_BOOTS("LEATHER_BOOTS"),
	LEATHER_CHESTPLATE("LEATHER_CHESTPLATE"), LEATHER_HELMET("LEATHER_HELMET"),
	LEATHER_HORSE_ARMOR(null, null, null, null, null, null, "LEATHER_HORSE_ARMOR"),
	LEATHER_LEGGINGS("LEATHER_LEGGINGS"), LECTERN(null, null, null, null, null, null, "LECTERN"), LEVER("LEVER"),
	...
	LINGERING_POTION_FIRE_RESISTANCE_EXTENDED(PotionBase.LINGERING, "FIRE_RESISTANCE", true, false, null,
			"LINGERING_POTION"),
	...
	LINGERING_POTION_TURTLE_MASTER_1_EXTENDED(PotionBase.LINGERING, "TURTLE_MASTER", true, false, null,
			"LINGERING_POTION"),
	...
	LINGERING_POTION_WATER_BREATHING_EXTENDED(PotionBase.LINGERING, "WATER_BREATHING", true, false, null,
			"LINGERING_POTION"),
	...
	MAGMA_BLOCK(null, null, "MAGMA", null, null, "MAGMA_BLOCK"), MAGMA_CREAM("MAGMA_CREAM"),
	MAGMA_CUBE_SPAWN_EGG(62, "MONSTER_EGG", null, null, null, null, "MAGMA_CUBE_SPAWN_EGG"),
	MAP("EMPTY_MAP", null, null, null, null, "MAP"), MELON("MELON_BLOCK", null, null, null, null, "MELON"),
	MELON_SEEDS("MELON_SEEDS"), MELON_SLICE("MELON", null, null, null, null, "MELON_SLICE"), MELON_STEM("MELON_STEM"),
	MILK_BUCKET("MILK_BUCKET"), MINECART("MINECART"),
	...
	MUSIC_DISC_WARD("RECORD_10", null, null, null, null, "MUSIC_DISC_WARD"), MUTTON("MUTTON"),
	MYCELIUM("MYCEL", null, null, null, null, "MYCELIUM"), NAME_TAG("NAME_TAG"),
	...
	NETHER_QUARTZ_ORE("QUARTZ_ORE", null, null, null, null, "NETHER_QUARTZ_ORE"), NETHER_STAR("NETHER_STAR"),
	NETHER_WART("NETHER_STALK", null, null, null, null, "NETHER_WART"),
	NETHER_WART_BLOCK("NETHER_WARTS", null, "NETHER_WART_BLOCK"), NETHERRACK("NETHERRACK"), NOTE_BLOCK("NOTE_BLOCK"),
	...
	OAK_LEAVES("LEAVES", null, null, null, null, "OAK_LEAVES"), OAK_LOG("LOG", null, null, null, null, "OAK_LOG"),
	...
	OAK_WOOD(12, "LOG", null, null, null, null, "OAK_WOOD"), OBSERVER(null, null, null, "OBSERVER"),
	OBSIDIAN("OBSIDIAN"), OCELOT_SPAWN_EGG(98, "MONSTER_EGG", null, null, null, null, "OCELOT_SPAWN_EGG"),
	...
	OXEYE_DAISY(8, "RED_ROSE", null, null, null, null, "OXEYE_DAISY"), PACKED_ICE("PACKED_ICE"), PAINTING("PAINTING"),
	PAPER("PAPER"), PARROT_SPAWN_EGG(105, null, null, null, null, "MONSTER_EGG", "PARROT_SPAWN_EGG"),
	...
	PINK_WOOL(6, "WOOL", null, null, null, null, "PINK_WOOL"), PISTON("PISTON_BASE", null, null, null, null, "PISTON"),
	...
	PODZOL(2, "DIRT", null, null, null, null, "PODZOL"), POISONOUS_POTATO("POISONOUS_POTATO"),
	...
	POPPY("RED_ROSE", null, null, null, null, "POPPY"), PORKCHOP("PORK", null, null, null, null, "PORKCHOP"),
	POTATO_ITEM("POTATO_ITEM", null, null, null, null, "POTATO"),
	POTATOES("POTATO", null, null, null, null, "POTATOES"), POTION("POTION"),
	...
	POTTED_WITHER_ROSE(null, null, null, null, null, null, "POTTED_WITHER_ROSE"), POWERED_RAIL("POWERED_RAIL"),
	PRISMARINE("PRISMARINE"), PRISMARINE_BRICK_SLAB(null, null, null, null, null, "PRISMARINE_BRICK_SLAB"),
	...
	PRISMARINE_CRYSTALS("PRISMARINE_CRYSTALS"), PRISMARINE_SHARD("PRISMARINE_SHARD"),
	...
	PUFFERFISH_SPAWN_EGG(null, null, null, null, null, "PUFFERFISH_SPAWN_EGG"), PUMPKIN("PUMPKIN"),
	PUMPKIN_PIE("PUMPKIN_PIE"), PUMPKIN_SEEDS("PUMPKIN_SEEDS"), PUMPKIN_STEM("PUMPKIN_STEM"),
	...
	PURPLE_WOOL(10, "WOOL", null, null, null, null, "PURPLE_WOOL"), PURPUR_BLOCK(null, "PURPUR_BLOCK"),
	PURPUR_PILLAR(null, "PURPUR_PILLAR"), PURPUR_SLAB(null, "PURPUR_SLAB"), PURPUR_STAIRS(null, "PURPUR_STAIRS"),
	QUARTZ("QUARTZ"), QUARTZ_BLOCK("QUARTZ_BLOCK"),
	QUARTZ_PILLAR(2, "QUARTZ_BLOCK", null, null, null, null, "QUARTZ_PILLAR"),
	QUARTZ_SLAB(7, "STEP", null, null, null, null, "QUARTZ_SLAB"), QUARTZ_STAIRS("QUARTZ_STAIRS"), RABBIT("RABBIT"),
	RABBIT_FOOT("RABBIT_FOOT"), RABBIT_HIDE("RABBIT_HIDE"),
	RABBIT_SPAWN_EGG(101, "MONSTER_EGG", null, null, null, null, "RABBIT_SPAWN_EGG"), RABBIT_STEW("RABBIT_STEW"),
	...
	RED_LEATHER_LEGGINGS("LEATHER_LEGGINGS", 14, Color.fromRGB(153, 51, 51)), RED_MUSHROOM("RED_MUSHROOM"),
	...
	RED_SAND(1, "SAND", null, null, null, null, "RED_SAND"), RED_SANDSTONE("RED_SANDSTONE"),
	...
	RED_WOOL(14, "WOOL", null, null, null, null, "RED_WOOL"), REDSTONE("REDSTONE"), REDSTONE_BLOCK("REDSTONE_BLOCK"),
	REDSTONE_LAMP("REDSTONE_LAMP_OFF", null, null, null, null, "REDSTONE_LAMP"),
	REDSTONE_LAMP_ON("REDSTONE_LAMP_ON", null, null, null, null, "REDSTONE_LAMP"), REDSTONE_ORE("REDSTONE_ORE"),
	...
	REDSTONE_WIRE("REDSTONE_WIRE"), REPEATER("DIODE", null, null, null, null, "REPEATER"),
	REPEATING_COMMAND_BLOCK("COMMAND", "COMMAND_REPEATING", null, null, null, "REPEATING_COMMAND_BLOCK"),
	ROSE_BUSH(4, "DOUBLE_PLANT", null, null, null, null, "ROSE_BUSH"), ROTTEN_FLESH("ROTTEN_FLESH"), SADDLE("SADDLE"),
	SALMON(1, "RAW_FISH", null, null, null, null, "SALMON"),
	SALMON_BUCKET(null, null, null, null, null, "SALMON_BUCKET"),
	SALMON_SPAWN_EGG(null, null, null, null, null, "SALMON_SPAWN_EGG"), SAND("SAND"), SANDSTONE("SANDSTONE"),
	SANDSTONE_SLAB(1, "STEP", null, null, null, null, "SANDSTONE_SLAB"), SANDSTONE_STAIRS("SANDSTONE_STAIRS"),
	SANDSTONE_WALL(null, null, null, null, null, null, "SANDSTONE_WALL"),
	SCAFFOLDING(null, null, null, null, null, null, "SCAFFOLDING"), SCUTE(null, null, null, null, null, "SCUTE"),
	SEA_LANTERN("SEA_LANTERN"), SEA_PICKLE(null, null, null, null, null, "SEA_PICKLE"),
	SEAGRASS(null, null, null, null, null, "SEAGRASS"), SHEARS("SHEARS"),
	SHEEP_SPAWN_EGG(91, "MONSTER_EGG", null, null, null, null, "SHEEP_SPAWN_EGG"), SHIELD(null, "SHIELD"),
	SHULKER_BOX(null, null, null, "WHITE_SHULKER_BOX"), SHULKER_SHELL(null, null, null, "SHULKER_SHELL"),
	...
	SKULL_BANNER_PATTERN(null, null, null, null, null, null, "SKULL_BANNER_PATTERN"), SLIME_BALL("SLIME_BALL"),
	SLIME_BLOCK("SLIME_BLOCK"), SLIME_SPAWN_EGG(55, "MONSTER_EGG", null, null, null, null, "SLIME_SPAWN_EGG"),
	SMITHING_TABLE(null, null, null, null, null, null, "SMITHING_TABLE"),
	SMOKER(null, null, null, null, null, null, "SMOKER"), SMOOTH_QUARTZ(null, null, null, null, null, "SMOOTH_QUARTZ"),
	...
	SMOOTH_STONE_SLAB(null, null, null, null, null, null, "SMOOTH_STONE_SLAB"), SNOW("SNOW"), SNOW_BLOCK("SNOW_BLOCK"),
	SNOWBALL("SNOW_BALL", null, null, null, null, "SNOWBALL"), SOUL_SAND("SOUL_SAND"),
	SPAWN_EGG("MONSTER_EGG", null, null, null, null, "LEGACY_MONSTER_EGG"),
	SPAWNER("MOB_SPAWNER", null, null, null, null, "SPAWNER"), SPECTRAL_ARROW("ARROW", "SPECTRAL_ARROW"),
	SPIDER_EYE("SPIDER_EYE"), SPIDER_SPAWN_EGG(52, "MONSTER_EGG", null, null, null, null, "SPIDER_SPAWN_EGG"),
	...
	SPLASH_POTION_HARMING_2(PotionBase.SPLASH, "INSTANT_DAMAGE", false, true, null, "SPLASH_POTION"),
	SPLASH_POTION_HEALING_1(PotionBase.SPLASH, "INSTANT_HEAL", false, false, null, "SPLASH_POTION"),
	SPLASH_POTION_HEALING_2(PotionBase.SPLASH, "INSTANT_HEAL", false, true, null, "SPLASH_POTION"),
	...
	SPONGE("SPONGE"), SPRUCE_BOAT("BOAT", null, null, null, "BOAT_SPRUCE", "SPRUCE_BOAT"),
	SPRUCE_BUTTON("WOOD_BUTTON", null, null, null, null, "SPRUCE_BUTTON"), SPRUCE_DOOR("SPRUCE_DOOR"),
	SPRUCE_DOOR_ITEM("SPRUCE_DOOR_ITEM", null, null, null, null, "SPRUCE_DOOR"), SPRUCE_FENCE("SPRUCE_FENCE"),
	SPRUCE_FENCE_GATE("SPRUCE_FENCE_GATE"), SPRUCE_LEAVES(1, "LEAVES", null, null, null, null, "SPRUCE_LEAVES"),
	...
	SQUID_SPAWN_EGG(94, "MONSTER_EGG", null, null, null, null, "SQUID_SPAWN_EGG"), STICK("STICK"),
	STICKY_PISTON("PISTON_STICKY_BASE", null, null, null, null, "STICKY_PISTON"), STONE("STONE"),
	STONE_AXE("STONE_AXE"), STONE_BRICK_SLAB(5, "STEP", null, null, null, null, "STONE_BRICK_SLAB"),
	...
	STONE_BRICKS("SMOOTH_BRICK", null, null, null, null, "STONE_BRICKS"), STONE_BUTTON("STONE_BUTTON"),
	STONE_HOE("STONE_HOE"), STONE_PICKAXE("STONE_PICKAXE"),
	...
	STONE_SLAB("STEP", null, null, null, null, "STONE_SLAB"), STONE_SWORD("STONE_SWORD"),
	STONECUTTER(null, null, null, null, null, null, "STONECUTTER"),
	STRAY_SPAWN_EGG(null, null, "MONSTER_EGG", null, null, "STRAY_SPAWN_EGG"), STRING("STRING"),
	...
	STRUCTURE_BLOCK(null, "STRUCTURE_BLOCK"), STRUCTURE_VOID(null, null, null, null, null, null, "STRUCTURE_VOID"),
	SUGAR("SUGAR"), SUGAR_CANE_ITEM("SUGAR_CANE"), SUNFLOWER("DOUBLE_PLANT", null, null, null, null, "SUNFLOWER"),
	...
	TIPPED_ARROW_FIRE_RESISTANCE_EXTENDED(PotionBase.TIPPED_ARROW, "FIRE_RESISTANCE", true, false, "ARROW",
			"TIPPED_ARROW"),
	...
	TIPPED_ARROW_TURTLE_MASTER_1_EXTENDED(PotionBase.TIPPED_ARROW, "TURTLE_MASTER", true, false, "ARROW",
			"TIPPED_ARROW"),
	...
	TIPPED_ARROW_WATER_BREATHING_EXTENDED(PotionBase.TIPPED_ARROW, "WATER_BREATHING", true, false, "ARROW",
			"TIPPED_ARROW"),
	...
	TNT("TNT"), TNT_MINECART("EXPLOSIVE_MINECART", null, null, null, null, "TNT_MINECART"), TORCH("TORCH"),
	...
	TRAPPED_CHEST("TRAPPED_CHEST"), TRIDENT(null, null, null, null, null, "TRIDENT"), TRIPWIRE("TRIPWIRE"),
	TRIPWIRE_HOOK("TRIPWIRE_HOOK"), TROPICAL_FISH("RAW_FISH", null, null, null, null, "TROPICAL_FISH"),
	...
	VINDICATOR_SPAWN_EGG(36, null, null, null, "MONSTER_EGG", null, "VINDICATOR_SPAWN_EGG"), VINE("VINE", 0),
	VOID_AIR("AIR", null, null, null, null, "VOID_AIR"), WALL_TORCH(null, null, null, null, null, "WALL_TORCH"),
	WANDERING_TRADER_SPAWN_EGG(null, null, null, null, null, null, "WANDERING_TRADER_SPAWN_EGG"), WATER("WATER"),
	WATER_BUCKET("WATER_BUCKET"), WET_SPONGE(1, "SPONGE", null, null, null, null, "WET_SPONGE"), WHEAT("WHEAT"),
	...
	WRITABLE_BOOK("BOOK_AND_QUILL", null, null, null, null, "WRITABLE_BOOK"), WRITTEN_BOOK("WRITTEN_BOOK"),
	...
	public ItemStack getItemStack() {
		...
		ItemStack is = m != null ? version.contains("1.8") || version.contains("1.9") || version.contains("1.10")
				|| version.contains("1.11") || version.contains("1.12") ? new ItemStack(m, 1, data) : new ItemStack(m)
				: null;
		if (is != null && attributes != null)
			for (final String s : attributes.split(";"))
				if (s.startsWith("color=")) {
					...
					is = new UPotion(PotionBase.valueOf(p[0]), p[1], Boolean.parseBoolean(p[2]),
							Boolean.parseBoolean(p[3])).getItemStack();
				}
		return is;
	}
	...
	public static UMaterial match(String name, byte data) {
		...
		if (inUMemory.containsKey(name + data))
			return inUMemory.get(name + data);
		for (final UMaterial u : UMaterial.values())
			if (u.getData() == data)
				for (final String n : u.names)
	...
	public static ItemStack valueOf(String name, byte data) {
		name = name.toUpperCase();
		if (inMemory.keySet().contains(name + data))
			return inMemory.get(name + data).clone();
		for (final UMaterial u : UMaterial.values())
			if (u.getData() == data)
				for (final String n : u.names)
					if (n != null && n.equals(name)) {
	...
	public static UMaterial matchSpawnEgg(ItemStack egg) {
		if (egg != null) {
			...
			if (v.contains("1.8"))
				...
				final String id = egg.hasItemMeta()
						? egg.getItemMeta().toString().split("id=")[1].split("}")[0].toUpperCase()
						: "PIG";
	...
	public static UMaterial matchEnchantedBook(ItemStack book) {
		if (book != null && book.getItemMeta() instanceof EnchantmentStorageMeta) {
			...
			if (s.size() == 1) {
				...
				final int l = s.get(e);
				final String n = e.getName(), name = n.equals("PROTECTION_ENVIRONMENTAL") ? "PROTECTION"
	...
	public static UMaterial matchPotion(ItemStack potion, PotionBase base) {
		if (potion != null && potion.getItemMeta() instanceof PotionMeta) {
			...
			if (ce.size() == 0) {
				...
				final String a = t.getName(),
						T = base.equals(PotionBase.NORMAL) ? "POTION_"
								: base.equals(PotionBase.SPLASH) ? "SPLASH_POTION_"
										: base.equals(PotionBase.LINGERING) ? "LINGERING_POTION_" : null,
	...
	public static UMaterial match(ItemStack item) {
		if (item != null) {
			...
			return un.contains("SPAWN_EGG") ? matchSpawnEgg(item)
					: un.contains("ENCHANTED_BOOK") ? matchEnchantedBook(item)
							: un.contains("POTION")
									? matchPotion(item, PotionBase.valueOf(un.contains("SPLASH") ? "SPLASH"
											: un.contains("LINGERING") ? "LINGERING" : "NORMAL"))
									: u;
		}
		return null;
	}
	...
	public static UMaterial getItem(Block block) {
		...
		UMaterial t = null;
		if (!v.contains("1.8") && !v.contains("1.9") && !v.contains("1.10") && !v.contains("1.11")
				&& !v.contains("1.12") || m.contains("TERRACOTTA") || m.startsWith("TORCH")
				|| m.startsWith("REDSTONE_TORCH") || m.contains("STAIRS") || m.equals("FLINT_AND_STEEL")
				|| m.equals("SOIL") || m.equals("LADDER") || m.equals("BONE_BLOCK") || m.equals("OBSERVER")
				|| m.contains("FENCE_GATE") || m.contains("TRAPDOOR") || m.contains("CHEST") || m.equals("DISPENSER")
				|| m.equals("DROPPER") || m.equals("JACK_O_LANTERN") || m.equals("PUMPKIN") || m.equals("HAY_BLOCK")
				|| m.contains("SHULKER_BOX") || m.equals("LEVER") || m.contains("BUTTON") || m.contains("RAIL")
				|| m.equals("FURNACE") || m.equals("VINE") || m.equals("TRIPWIRE_HOOK") || m.equals("HOPPER")
				|| m.equals("END_ROD"))
			return match(m);
	...
	public static UMaterial match(String name) {
		try {
			...
			if (inUMemory.containsKey(name + d))
				return inUMemory.get(name + d);
			for (final UMaterial u : UMaterial.values()) {
	...
	public enum PotionBase {
		NORMAL, ARROW, TIPPED_ARROW, LINGERING, SPLASH,
	}
}

class UPotion {
	private static final String v = Bukkit.getVersion();
	private static boolean eight = v.contains("1.8"), nine = v.contains("1.9"), ten = v.contains("1.10"),
			eleven = v.contains("1.11"), twelve = v.contains("1.12");
	...
	public UPotion(UMaterial.PotionBase base, String type, boolean extended, boolean upgraded) {
		...
		final PotionType t = eight
				&& (type.equals("AWKWARD") || type.equals("LUCK") || type.equals("MUNDANE") || type.equals("THICK"))
				|| (eight || nine || ten || eleven || twelve)
						&& (type.equals("TURTLE_MASTER") || type.equals("SLOW_FALLING")) ? PotionType.WATER
								: PotionType.valueOf(type);
		this.type = t;
		final String bn = base.name();
		if (eight) {
			potion = t.equals(PotionType.WATER) ? new Potion(t).toItemStack(1)
					: new Potion(t, upgraded ? 2 : 1, bn.equals("SPLASH")).toItemStack(1);
			potiondata = potion.getItemMeta();
		} else {
			final ItemStack is = new ItemStack(Material.matchMaterial(bn.equals("NORMAL") ? "POTION"
					: bn.contains("ARROW") ? bn.contains("TIPPED") ? "TIPPED_ARROW" : "ARROW" : bn + "_POTION"));
